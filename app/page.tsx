...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-10">
      <section className="section-frame grid gap-10 px-4 py-7 sm:px-6 md:grid-cols-[minmax(0,1.45fr)_minmax(320px,0.9fr)] md:px-8 md:py-10">
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-base leading-7 sm:text-lg sm:leading-8 text-ink/68">
        ...
        <div className="grid gap-4 self-start">
          <article className="rounded-[24px] border border-black/10 bg-paper px-5 py-5">
            ...
            <p className="mt-5 font-serif-display text-5xl leading-none text-ink sm:text-6xl">
              {data.totalPlayers}
            </p>
